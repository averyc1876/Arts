...
public class AOGGroundStorageRenderer : IRenderer
{
    private readonly ICoreClientAPI capi;
    private readonly AOGBlockEntityGroundStorage groundStorage;
    ...
    public AOGGroundStorageRenderer(ICoreClientAPI capi, AOGBlockEntityGroundStorage groundStorage)
    {
        this.capi = capi;
