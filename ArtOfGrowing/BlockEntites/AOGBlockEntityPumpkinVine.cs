...
{
    public class AOGBlockEntityPumpkinVine : BlockEntity
    {
        #region Config
        /// <summary>
        ...
        public AOGBlockEntityPumpkinVine() : base()
        {
        ...
        private void TrySpawnPumpkin(double curTotalHours)
        {
            foreach (BlockFacing facing in BlockFacing.HORIZONTALS)
            {
                ...
                if (AOGPumpkinCropBehavior.CanSupportPumpkin(Api, candidatePos.DownCopy()))
                {
